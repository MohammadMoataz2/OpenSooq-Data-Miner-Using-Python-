...
def open_souq_scraping(url_of_posts,number_of_pages):
    ...
    for page_number in range(1, number_of_pages + 1):  # Adjust the range accordingly
        ...
        try:
            ...
            listing_post = soup.find("section", {"id": "serpMainContent"}).find_all("a", class_="block blackColor p-16")


            listing_post_urls = [post["href"] for post in listing_post]
            print(listing_post_urls)
